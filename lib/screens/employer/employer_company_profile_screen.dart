...
class EmployerCompanyProfilePage extends StatefulWidget {
  const EmployerCompanyProfilePage({super.key});

  @override
  State<EmployerCompanyProfilePage> createState() => _EmployerCompanyProfilePageState();
}

class _EmployerCompanyProfilePageState extends State<EmployerCompanyProfilePage> {
