...
//       if (_roleController.text.trim().toLowerCase() == 'woman') {
//         updateData['emergencyEmail'] = _emergencyEmailController.text.trim();
//       }
...
//                     // Emergency email input field (for Woman only)
//                     if (_roleController.text.trim().toLowerCase() == 'woman')
//                       TextFormField(
...
//                     ),
//                     const SizedBox(height: 20.0),
//                     // Manage Company Profile button (Employer only)
//                     if (_roleController.text.trim().toLowerCase() == 'employer')
//                       SizedBox(
//                         width: double.infinity,
//                         child: ElevatedButton(
//                           onPressed: () {
